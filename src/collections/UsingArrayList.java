 ...
 * Duplicate elements & Multiple 'nulls' allowed
 * */
...
public class UsingArrayList {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> intArrayList = new ArrayList<Integer>(); // store specific data type using wrapper class
        ArrayList<Employee> employeeArrayList = new ArrayList<Employee>(); // store specific object data type
